...
(setq centaur-tabs-vertical-line-spacing nil)
;; or match centaur-tabs height
;; (setq centaur-tabs-vertical-line-spacing 'match)
;; Hover highlight for tabs/buttons (nil disables)
(setq centaur-tabs-vertical-mouse-face nil)
;; (setq centaur-tabs-vertical-mouse-face 'highlight)
(setq centaur-tabs-vertical-show-icons t)
(setq centaur-tabs-vertical-show-group nil)
(setq centaur-tabs-vertical-show-group-list nil)
(setq centaur-tabs-vertical-show-new-tab-button t)
(setq centaur-tabs-vertical-show-navigation-buttons nil)
#+end_src
